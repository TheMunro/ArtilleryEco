...
public:
	...
	static inline JPH::Vec3 ToJoltCoordinates(FVector3f In)
	{
		return JPH::Vec3(In.X/100.0, In.Z/100.0, In.Y/100.0); //reverse is 0,2,1
	};
	...
	static inline FVector3f FromJoltUnitVector(JPH::Vec3 In)
	{
	...
	static inline JPH::Quat ToJoltRotation(FQuat4f In)
	{
		return JPH::Quat(-In.X, -In.Z, -In.Y, In.W);
	}
