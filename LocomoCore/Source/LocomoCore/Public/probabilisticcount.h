...
public:
    ...
    double report() const {
        //there's what looks AWFUL LIKE a bug in here, so I'm swapping to the basic flow.
        //this bleeds acceleration badly, but on the other hand, this is already fast
        //and just having an extant prcounter is nice.
//         CONST_IF(sizeof(T) == 4) {
...
//                 SK_UNROLL_8
//                 for(unsigned ii = 0; ii < nper; ++ii) {
//                     start[i] = popcount(start[ii]);
//                 }
...
//             // Reduce
//             double sum = 0.;
//             //@maslab TODO: could you figure out why this shadows i? unlike the other cases, I think this is intentional.
